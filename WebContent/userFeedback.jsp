...
<div id="wrapper">
	...
	<!-- end #header -->
       ...
       <li><a href="mhome.jsp" style="color:white;font-weight: 30px">Home</a></li>
        ...
        <div> <center> <h2><font color="navy">Feed Back on Service</font></h2> <br> 
		 <div class="hoving">
 
   <form class="login1"name="fun" action="feedback_DB" method="post">
                    ...
                    <table>
                        <tr>
                         ...
                         <tr>
                            <td>Comment:</td>
                            <td><input type="text" name="cmnt" placeholder="Enter your feedback" required/></td>
                        </tr>
                    </table>
