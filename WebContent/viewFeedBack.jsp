...
<div id="wrapper">
	...
	<!-- end #header -->
       ...
       <li>
        ...
        <div> <center> <h2><font color="navy">User FeedBacks</font></h2> <br> 
		 <div class="hoving">
   ...
   <table>
          ...
          PreparedStatement pst=con.prepareStatement("select * from feedback");
            ...
            ResultSet rs=pst.executeQuery();
              ...
              %>
              <form action="adminfbquestion.jsp?uid=<%=uid%>&feed=<%=feed%>" method="post"> <tr>
                  <td><%=uid%></td>
                  <td><%=feed%></td>
                  <td><input type="text" name="ques"  placeholder="Type question here" required/></td>
