...
<div id="wrapper">
	...
	<!-- end #header -->
      ...
      <!--  <li>
        ...
        <div> <center> <h2><font color="navy">User Side Technical Issues</font></h2> <br> 
		 <div class="hoving">
          ...
          PreparedStatement pst=con.prepareStatement("select * from techissue");
            ...
            ResultSet rs=pst.executeQuery();
              ...
              %>
              <form action="issueReplay.jsp?uid=<%=uid%>&issue=<%=issue%>" method="post"> <tr>
                  <td><%=uid%></td>
                  <td><%=issue%></td>
                  <td><input type="text" name="ans" id="ans" placeholder="Type reply here" required/></td>
                 <!-- <td>    <a href="issueReplay.jsp?uid=<%=uid%>&issue=<%=issue%>">Reply</a></td>-->
