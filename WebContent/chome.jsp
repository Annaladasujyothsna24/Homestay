...
<div id="wrapper">
	...
	<!-- end #header -->
        ...
        <!--  <li>
            <a href="Plan_Reg.jsp" style="color:white;font-weight: 30px">Plan HomeStay</a>
           
        </li> -->
           <li>
            <a href="addPlan.jsp?uid=<%=uid %>" style="color:white;font-weight: 30px">Add HomeStay</a>
           
        </li>
        <li>
            <a href="viewplan.jsp?uid=<%=uid %>" style="color:white;font-weight: 30px">Update Homestay</a>
           
        </li>
        
        <li>
            <a href="ViewClaimRequests.jsp?uid=<%=uid %>" style="color:white;font-weight: 30px">View Booking Requests</a>
           
        </li>
            <li>
            <a href="BillGenerate.jsp?uid=<%=uid%>" style="color:white;font-weight: 30px">Bill Generate</a>
        ...
        <div> <center> <h2><font color="navy">HomeStay Owner Home Page</font></h2> <br> 
		 <div class="hoving">
