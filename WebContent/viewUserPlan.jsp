...
<div id="wrapper">
	...
	<!-- end #header -->
       ...
       <li>
        ...
        <div> <center> <h2><font color="navy">Plan Details</font></h2> <br> 
		 <div class="hoving">
                     <div>
                         <table>
                             <tr><th>Plan Id</th>
          ...
          PreparedStatement pst=con.prepareStatement("select * from plan_reg where userid=?");
           pst.setString(1,uid);
            ResultSet rs=pst.executeQuery();
              while(rs.next()){
                   String pid=rs.getString("planid");
                   String pname=rs.getString("type");
                   String pdate=rs.getString("regdate");
