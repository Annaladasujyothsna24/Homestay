...
<div id="wrapper">
	...
	<!-- end #header -->
        ...
        <div> <center> <h2><font color="navy">User Login</font></h2> <br> 
		 <div class="hoving">
  <form class="login1"name="fun" action="ulogin_DB.jsp" method="post">
    ...
    <input type="password" name="pswrd" id="pass" class="span3" placeholder="Password" required/><br>
             ...
             <!-- <input type="radio" value="Member" name="utype" required/> Member
              <input type="radio" value="Agent" name="utype" required/> Agent--><br>
     <button class="btn btn-success" type="submit">Submit</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button class="btn btn-danger" type="reset">Clear</button>
  </form>
  <h4><a href="register.jsp?reg" style="text-decoration:none;">Create an account</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <!--  <a href="ForgotUserId.jsp" style="text-decoration:none;">Forgot User Id</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
  <!-- <a href="forgotUserPwd.jsp?reg" style="text-decoration:none;">Forgot Password</a></h4> -->
    </div>
                </center>
	</div>
