       ...
       <li>
        ...
        <div> <center> <h2><font color="navy">Reports</font></h2> <br> 
		 <div class="hoving">
                     ...
                     <form class="login1"name="fun" action="claimReport.jsp" method="post">
   
                    <table>
                        <tr>
                            <td>Claim Status:</td>
                            <td><select name="cstatus"><option value=""></option>
                         ...
                         <tr>
                            <td>Plan Period:</td>
                            <td>From:<input type="date" name="from" required/>
                           
                            <br>To:<input type="date" name="to" required/></td>
                        </tr>
