...
<div id="wrapper">
	...
	<!-- end #header -->
       ...
       <!-- <li>
        ...
        <div> <center> <h2><font color="navy">Booking Requests Details</font></h2> <br> 
                    <div class="hoving">
          ...
          PreparedStatement pst=con.prepareStatement("select * from claimrequest ");
           ...
           String uid="";
            ResultSet rs=pst.executeQuery();
              while(rs.next()){
                   ...
                   PreparedStatement pst1=con.prepareStatement("select * from plan where pid = ?");
              ...
              <tr>
                 ...
                 if(status.equalsIgnoreCase("waiting"))
                                         { %><td><a href="approveClaim.jsp?uid=<%=uid%>&pid=<%=pid%>&cid=<%=cid%>">Approve</a></td>
                                         <%
                 }
                   else
                   {
