...
<div id="wrapper">
	...
	<!-- end #header -->
       ...
       <!-- <li>
        ...
        <div> <center> <h2><font color="navy">Registered Users Information</font></h2> <br> 
                    <div class="hoving">
            ...
            ResultSet rs=pst.executeQuery();
              ...
              <tr>
                 ...
                 if(status.equalsIgnoreCase("waiting"))
                                         { %><td><a href="ustatus.jsp?id=<%=uid%>">Approve</a>&nbsp;&nbsp;<a href="ustatus2.jsp?id=<%=uid%>">Reject</a></td>
                                         <%
                 }
                   else
                   {
	 ...
	 <br>    <center><h3> <a href="ahome.jsp">Back</a></h3></center>
	<!-- end #page --> 
</div>
