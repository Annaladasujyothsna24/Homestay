...
<div id="wrapper">
	...
	<!-- end #header -->
       ...
       <li><a href="mhome.jsp" style="color:white;font-weight: 30px">Home</a></li>
        ...
        <div> <center> <h2><font color="navy">Technical Issues</font></h2> <br> 
		 <div class="hoving">
 
                     
                       <form class="login1"name="fun" action="techissue_DB" method="post">
                    ...
                    <table>
                        <tr>
                         ...
                         <tr>
                            <td>Issue:</td>
                            <td><input type="text" name="issue" placeholder="Enter Issue" required/></td>
                        </tr>
                    </table>
